...
import 'package:stores/screenes/profiles/returns/return_details.dart';
...
class Returns_Screen extends StatefulWidget {
  @override
  State<Returns_Screen> createState() => Returns_ScreenState();
}

class Returns_ScreenState extends State<Returns_Screen> {
  String searchText = '';
                  ...
                  children: [
                    ...
                    Table(border: TableBorder.all(), columnWidths: {
                      ...
                      TableRow(children: [
                        ...
                        Center(child: Custom_Text(text: '  ', size: 1.3.dg.sp)),
                      ]),
                      custom_Table_1(),
                    ]),
  ...
  TableRow custom_Table_1() {
    return TableRow(children: [
      ...
      ScaleButton(
        ...
        child: InkWell(
          onTap: () {
            pushNewScreen(context, Details_Screen());
          },
          child: Center(
            child: Padding(
