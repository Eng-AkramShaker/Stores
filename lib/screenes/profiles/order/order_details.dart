...
class Order_Details_Screen extends StatefulWidget {
  @override
  State<Order_Details_Screen> createState() => Order_Details_ScreenState();
}

class Order_Details_ScreenState extends State<Order_Details_Screen> {
  String searchText = '';
                  ...
                  children: [
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Custom_Text(text: 'المنتجات', size: 1.8.dg.sp),
                          ],
                        ),
                      ),
                    ),
                    ...
                    Center(
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Custom_Text(text: 'سجل الطلب', size: 1.8.dg.sp),
                          ],
                        ),
                      ),
                    ),
